...
function parseAnalogMeasurement(payload, serie) {
  ...
  const mType1 = { variable: 'mType1', value: getTypeAnalog(mType[0]), time, serie };
  const mBit1 = { variable: 'mBit1', value: mBit[0], time, serie };
  // const rfu1 = { variable: "rfu1", value: rfu[0], time, serie };
  ...
  const mType2 = { variable: 'mType2', value: getTypeAnalog(mType[1]),time, serie };
  const mBit2 = { variable: 'mBit2', value: mBit[1], time, serie };
  // const rfu2 = { variable: "rfu2", value: rfu[1], time, serie };
  ...
  const mType3 = { variable: 'mType3', value: getTypeAnalog(mType[2]), time, serie };
  const mBit3 = { variable: 'mBit3', value: mBit[2], time, serie };
  // const rfu3 = { variable: "rfu3", value: rfu[2], time, serie };
  ...
  const mType4 = { variable: 'mType4', value: getTypeAnalog(mType[3]), time, serie };
  const mBit4 = { variable: 'mBit4', value: mBit[3], time, serie };
  // const rfu4 = { variable: "rfu4", value: rfu[3], time, serie };
...
function getTypeAnalog(typeAnalog) {
  switch (typeAnalog) {
    case 0:
      return "4-20 mA";
    case 1:
...
function parseAnalog(payload, serie) {
  ...
  switch (sensorType) {
    case '00': {
      ...
      const m = parseAnalogMeasurement(payload.substring(4, 28), serie)
      return [sensorName, ...m];
    }
    case '01': {
...
var data = payload.find((x) => x.variable === 'payload' || x.variable === "payload_raw" || x.variable === "data");
if (data) {
