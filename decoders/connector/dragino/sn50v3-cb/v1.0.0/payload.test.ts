  ...
  test("Output Result", () => {
    expect(payload).toEqual(
      expect.arrayContaining([
        expect.objectContaining({ variable: "imei", value: "861562073745280" }),
  ...
  let payload = [
    {
      ...
      value:
        '{"IMEI": "860751074067197","IMSI": "724068042540503","Model": "DTN-300-FSN7-DC","mod": 8,"battery": 3.60,"signal": 24,"time": "2025/03/15 16:55:01","adc2": 2,"DS18B20_Temp": -409.5,"interrupt": 0,"interrupt_level": 0,"interrupt_pa4": 0,"interrupt_level_pa4": 0,"interrupt_pa8": 0,"interrupt_level_pa8": 0}',
    },
  ];
  payload = decoderRun(file_path, { payload });
...
// {"IMEI":"861562073745280","IMSI":"724068042540503","Model":"SN50V3-NB","mod":1,"battery":3.59,"signal":26,"time":"2000/01/01 00:54:34","DS18B20_Temp":-409.5,"digital_in":0,"interrupt":0,"interrupt_level":0,"adc1":2,"temperature":0.0,"humidity":0.0,"1":[0.0,0.0,1,-409.5,"2000/01/01 07:14:11"],"2":[0.0,0.0,1,-409.5,"2000/01/01 06:59:11"],"3":[0.0,0.0,2,-409.5,"2000/01/01 06:44:11"],"4":[0.0,0.0,1,-409.5,"2000/01/01 06:29:11"],"5":[0.0,0.0,2,-409.5,"2000/01/01 06:14:11"],"6":[0.0,0.0,1,-409.5,"2000/01/01 05:59:11"],"7":[0.0,0.0,1,-409.5,"2000/01/01 05:44:11"],"8":[0.0,0.0,1,-409.5,"2000/01/01 05:29:11"]}
