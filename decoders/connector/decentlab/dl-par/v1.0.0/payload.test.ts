...
const file_path =
  "decoders/connector/decentlab/dl-par/v1.0.0/payload.js" as const;

  describe("Payload decoder test 1", () => {
  const payload = [
    {
      variable: "payload",
      value: "020291000380690c60",
    },
  ];
  ...
  test("Decoded values", () => {
    ...
    expect(values.device_id).toBe(657);
    expect(values.photosynthetically_active_radiation).toBe(48.07);
