...
const file_path =
  "decoders/connector/decentlab/dl-dlr2-011/v1.0.0/payload.js" as const;

  describe("Payload decoder test 1", () => {
  const payload = [
    {
      variable: "payload",
      value: "0243710007000100000af9",
    },
  ];
  ...
  test("Decoded values", () => {
    ...
    expect(values.ch0_input).toBe(1);
    expect(values.ch1_input).toBe(0);
    expect(values.device_id).toBe(17265);
