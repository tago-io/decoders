...
const file_path =
  "decoders/connector/decentlab/dl-zn1/v1.0.0/payload.js" as const;

  describe("Payload decoder test 1", () => {
  const payload = [
    {
      variable: "payload",
      value: "0211110003409a00860c54",
    },
  ];
  ...
  test("Decoded values", () => {
    ...
    expect(values.dendrometer_position).toBe(976.93);
