    ...
    try {
        ...
        // Port 2: Data packet
            ...
            if (bytes.length === 8) {
                ...
                parsedResults.push({ variable: "temperature", value: temperature / 100.0, unit: "°C" }, { variable: "humidity", value: humidity / 100.0, unit: "%" }, { variable: "air_pressure", value: air_pressure / 10.0, unit: "hPa" }, { variable: "vbat", value: vbat, unit: "mV" });
            }
                ...
                parsedResults.push({ variable: "status", value: status, unit: "" }, { variable: "temperature", value: temperature / 100.0, unit: "°C" }, { variable: "humidity", value: humidity / 100.0, unit: "%" }, { variable: "air_pressure", value: air_pressure / 10.0, unit: "hPa" }, { variable: "vbat", value: vbat, unit: "mV" });
            }
                ...
                parsedResults.push({ variable: "temperature", value: temperature / 100.0, unit: "°C" }, { variable: "humidity", value: humidity / 100.0, unit: "%" }, { variable: "air_pressure", value: air_pressure / 10.0, unit: "hPa" }, { variable: "vbat", value: vbat, unit: "mV" }, { variable: "unixtime", value: unixtime, unit: "s" });
            }
                ...
                parsedResults.push({ variable: "status", value: status, unit: "" }, { variable: "temperature", value: temperature / 100.0, unit: "°C" }, { variable: "humidity", value: humidity / 100.0, unit: "%" }, { variable: "air_pressure", value: air_pressure / 10.0, unit: "hPa" }, { variable: "vbat", value: vbat, unit: "mV" }, { variable: "unixtime", value: unixtime, unit: "s" });
            }
        }
        // Port 3: Config packet (source has no length check — mirrored as-is)
            ...
            parsedResults.push({ variable: "status", value: status, unit: "" }, { variable: "send_period", value: send_period_strings[sp], unit: "" }, { variable: "move_thr", value: move_thr, unit: "" }, { variable: "packet_confirm", value: packet_confirm, unit: "" }, { variable: "data_rate", value: data_rate, unit: "" }, { variable: "adr_on", value: adr_on, unit: "" }, { variable: "family_id", value: family_id, unit: "" }, { variable: "product_id", value: product_id, unit: "" }, { variable: "hw", value: hw / 10, unit: "" }, { variable: "fw", value: fw / 10, unit: "" });
        }
