...
const file_path = "decoders/connector/lansitec/nb-iot-macro-bluetooth-gateway/v1.0.0/payload.ts" as const;
...
describe("Nb-iot macro bluetooth gateway heartbeat unit tests", () => {
  const payloadHex = "20F3803000200B01000023000400000000000100000000";
  ...
  test("Check variable values", () => {
    ...
    expect(result.chargeDuration?.value).toBe(0);
