...
const file_path = "decoders/connector/lansitec/macro-bluetooth-gateway/v1.0.0/payload.ts" as const;
...
describe("Macro bluetooth gateway heartbeat unit tests", () => {
  ...
  test("Check variable values", () => {
    ...
    expect(result.battery?.value).toBe(3.53);
