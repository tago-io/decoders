...
const file_path = "decoders/connector/lansitec/socket-sync-bluetooth-gateway/v1.0.0/payload.ts" as const;
...
describe("Socket sync bluetooth gateway heartbeat unit tests", () => {
  const payloadHex = "21643E033E00600000";
