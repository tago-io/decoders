...
function Decoder(bytes, port) {
  ...
  if (port === 136) {
    ...
    decoded.push({ variable: "remaining_battery_capacity", value: Number((100 * ((battery_level >> 4) / 15)).toPrecision(4)), unit: "%" });
    // TEMPERATURE
    ...
    decoded.push({ variable: "location", value: `${positionLatitude},${positionLongitude}`, location: { lat: positionLatitude, lng: positionLongitude } });
