...
const ignore_vars = ['timestamp','rssi','snr','application_id','device_id','downlink_key','lora_bandwidth','lora_spreading_factor','data_rate_index','coding_rate','frequency','time','gateway_eui'];
