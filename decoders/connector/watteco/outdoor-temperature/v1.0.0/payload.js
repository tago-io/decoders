...
function Decoder(bytes, port) {
    ...
    if (port === 125){
      ...
      {
        var decoded = {};
        brData = (brUncompress(3,[{taglbl: 0,resol: 10, sampletype: 7,lblname: "temperature", divide: 100}, { taglbl: 5, resol: 100, sampletype: 6, lblname: "BatteryVoltage", divide: 1000}], lora.payload, lDate))
