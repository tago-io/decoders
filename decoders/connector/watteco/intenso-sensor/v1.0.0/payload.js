  ...
  for( var j = 0; j < bytes_len_; j++ ){
    ...
    if (port === 125){
      ...
      if (decodedBatch === false){
        ...
        var decoded = {};
        brData = (brUncompress(3,[{taglbl: 0,resol: 0.004, sampletype: 12,lblname: "NA", divide: 1},{ taglbl: 1, resol: 1, sampletype: 12,lblname: "Current", divide: 1}, { taglbl: 2, resol: 100, sampletype: 6,lblname: "BatteryVoltage", divide: 1000}, { taglbl: 3, resol: 100, sampletype: 6,lblname: "ExternalPowerVoltage", divide: 1000},{ taglbl: 4, resol: 1, sampletype: 10,lblname: "Index", divide: 1}], lora.payload, lDate))
