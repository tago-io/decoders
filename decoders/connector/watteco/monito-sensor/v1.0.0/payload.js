  ...
  for( var j = 0; j < bytes_len_; j++ ){
    ...
    if (port === 125){
      ...
      if (decodedBatch === false){
        ...
        var decoded = {};
        brData = (brUncompress(3,[{taglbl: 0,resol: 0.02, sampletype: 12,lblname: "0-100mV", divide: 1},{ taglbl: 1, resol: 15, sampletype: 12,lblname: "0_70V", divide: 1}, { taglbl: 2, resol: 100, sampletype: 6,lblname: "BatteryVoltage", divide: 1000}], lora.payload, lDate))
