...
const ignore_vars = ['drivercfg','modelcfg','basestationdata','devlrrcnt','lrrlon','lrrlat','late','lrrid','channel','subband','spfact','lrresp','lrrsnr','lrrrssi','lrcid','mic_hex','mtype','adrbit','lostuplinksas','fcntdn','ackrequested','rawmaccommands','txpower','nbtrans','points','downlinkurl',/*'application_id','device_id','downlink_key',*/'lora_bandwidth','lora_spreading_factor','data_rate_index','coding_rate','frequency','time','gateway_eui'];
