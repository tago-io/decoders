...
const testPayloads = {
    "data": [
        { "fport": 1, "bytes": "273ef1336472e30c000000", "name": "Standard Payload" },
        { "fport": 2, "bytes": "0122022203220422052200", "name": "Modbus Standard Payload" },
        { "fport": 3, "bytes": "0122022203220422052200", "name": "Modbus Standard Payload" },
        { "fport": 4, "bytes": "0122022203220422052200", "name": "Modbus Standard Payload" },
        { "fport": 5, "bytes": "0122022203220422052200", "name": "Modbus Standard Payload" },
        { "fport": 6, "bytes": "0122022203220422052200", "name": "Modbus Standard Payload" },
        { "fport": 7, "bytes": "0122022203220422052200", "name": "Modbus Standard Payload" },
        { "fport": 8, "bytes": "0122022203220422052200", "name": "Modbus Standard Payload" },
        { "fport": 9, "bytes": "0122022203220422052200", "name": "Modbus Standard Payload" },
        { "fport": 20, "bytes": "cc0d3900000c0000000400", "name": "Heartbeat 2.0 Payload" },
        { "fport": 30, "bytes": "0f2041d30000", "name": "One Analog Input Payload" },
        { "fport": 40, "bytes": "1227411ffefa3a4022147b", "name": "Two Analog Input Payload" },
        { "fport": 50, "bytes": "0f000e00", "name": "Digital Input Payload" },
        { "fport": 60, "bytes": "681ebd64ffff0000000000", "name": "Event Log Payload" },
        { "fport": 70, "bytes": "004ae6e23c002405200000", "name": "Configuration Payload" },
        { "fport": 100, "bytes": "0313020000000000000000", "name": "Modbus Generic Payload - One Register Group" },
        { "fport": 110, "bytes": "01fe3f80000002fe4000000003fe3f800000003a405810620f2041b60000", "name": "VoBo-XX Analog Input Variable Length Payload" },
        { "fport": 120, "bytes": "0f270f270f270f270f270f270f2701", "name": "VoBo-XX Modbus Standard Variable Length Payload" },
    ]
}
...
describe(`fPort: ${testPayloads.data[9].fport} - ${testPayloads.data[9].name}`, () => { // fPort 20
    const raw_payload = [
        { variable: "bytes", value: testPayloads.data[9].bytes },
...
describe(`fPort: ${testPayloads.data[10].fport} - ${testPayloads.data[10].name}`, () => { // fPort 30
    const raw_payload = [
        { variable: "bytes", value: testPayloads.data[10].bytes },
...
describe(`fPort: ${testPayloads.data[11].fport} - ${testPayloads.data[11].name}`, () => { // fPort 40
    const raw_payload = [
        { variable: "bytes", value: testPayloads.data[11].bytes },
...
describe(`fPort: ${testPayloads.data[12].fport} - ${testPayloads.data[12].name}`, () => { // fPort 50 
    const raw_payload = [
        { variable: "bytes", value: testPayloads.data[12].bytes },
...
describe(`fPort: ${testPayloads.data[13].fport} - ${testPayloads.data[13].name}`, () => { // fPort 60
    const raw_payload = [
        { variable: "bytes", value: testPayloads.data[13].bytes },
...
describe(`fPort: ${testPayloads.data[14].fport} - ${testPayloads.data[14].name}`, () => { // fPort 70
    const raw_payload = [
        { variable: "bytes", value: testPayloads.data[14].bytes },
...
describe(`fPort: ${testPayloads.data[15].fport} - ${testPayloads.data[15].name}`, () => { // fPort 100
    const raw_payload = [
        { variable: "bytes", value: testPayloads.data[15].bytes },
...
describe(`fPort: ${testPayloads.data[16].fport} - ${testPayloads.data[16].name}`, () => { // fPort 110
    const raw_payload = [
        { variable: "bytes", value: testPayloads.data[16].bytes },
...
describe(`fPort: ${testPayloads.data[17].fport} - ${testPayloads.data[17].name}`, () => { // fPort 120
    const raw_payload = [
        { variable: "bytes", value: testPayloads.data[17].bytes },
