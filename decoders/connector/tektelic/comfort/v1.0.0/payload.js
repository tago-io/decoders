...
function parsePayload(input) {
    ...
    decoder = [
      ...
      },
      {
        ...
        fn: function (arg) {
          ...
          decoded_data["loramac_dr_tx"]["dr_number"] = decode_field(
            arg,
            2,
            11,
            8,
      ...
      },
      {
        ...
        fn: function (arg) {
          ...
          decoded_data["loramac_rx2"]["dr_number_rx2"] = decode_field(
            arg,
            5,
            7,
            0,
      ...
      },
      {
        key: [0x19],
        fn: function (arg) {
          decoded_data["loramac_net_id_msb"] = decode_field(
            arg,
            2,
            15,
            0,
      ...
      },
      {
        key: [0x1a],
        fn: function (arg) {
          decoded_data["loramac_net_id_lsb"] = decode_field(
            arg,
            2,
            15,
            0,
      ...
      },
      {
        key: [0x21],
        fn: function (arg) {
          decoded_data["tick_per_battery"] = decode_field(
            arg,
            2,
            15,
            0,
      ...
      },
      {
        key: [0x22],
        fn: function (arg) {
          decoded_data["tick_per_ambient_temperature"] = decode_field(
            arg,
            2,
            15,
            0,
      ...
      },
      {
        key: [0x23],
        fn: function (arg) {
          decoded_data["tick_per_relative_humidity"] = decode_field(
            arg,
            2,
            15,
            0,
      ...
      },
      {
        key: [0x24],
        fn: function (arg) {
          decoded_data["tick_per_reed_switch"] = decode_field(
            arg,
            2,
            15,
            0,
      ...
      },
      {
        key: [0x25],
        fn: function (arg) {
          decoded_data["tick_per_light"] = decode_field(
            arg,
            2,
            15,
            0,
      ...
      },
      {
        key: [0x27],
        fn: function (arg) {
          decoded_data["tick_per_mcu_temperature"] = decode_field(
            arg,
            2,
            15,
            0,
      ...
      },
      {
        key: [0x28],
        fn: function (arg) {
          decoded_data["tick_per_pir"] = decode_field(
            arg,
            2,
            15,
            0,
      ...
      },
      {
        key: [0x29],
        fn: function (arg) {
          decoded_data["tick_per_external_connector"] = decode_field(
            arg,
            2,
            15,
            0,
      ...
      },
      {
        key: [0x2b],
        fn: function (arg) {
          decoded_data["reed_switch_count_threshold"] = decode_field(
            arg,
            2,
            15,
            0,
      ...
      },
      {
        ...
        fn: function (arg) {
          ...
          var val = decode_field(arg, 1, 0, 0, "unsigned");
          {
            switch (val) {
              ...
              case 1:
                ...
                break;
              default:
                decoded_data["external_mode"]["rising_edge_enabled_ex"] =
                  "Invalid";
            }
          }
          var val = decode_field(arg, 1, 1, 1, "unsigned");
          {
            switch (val) {
              case 0:
                decoded_data["external_mode"]["falling_edge_enabled_ex"] =
                  "Off";
                break;
              case 1:
      ...
      },
      {
        key: [0x2e],
        fn: function (arg) {
          decoded_data["external_connector_count_threshold"] = decode_field(
            arg,
            2,
            15,
            0,
      ...
      },
      {
        ...
        fn: function (arg) {
          ...
          decoded_data["external_values_to_transmit"]["count_type"] =
            decode_field(arg, 1, 4, 4, "unsigned");
          return 1;
        },
      },
      {
        key: [0x30],
        fn: function (arg) {
          decoded_data["impact_event_threshold"] = (
            decode_field(arg, 2, 15, 0, "unsigned") * 0.001
          ).toFixed(3);
          return 2;
        },
      },
      {
        key: [0x31],
        fn: function (arg) {
          decoded_data["acceleration_event_threshold"] = (
            decode_field(arg, 2, 15, 0, "unsigned") * 0.001
          ).toFixed(3);
          return 2;
        },
      ...
      },
      {
        key: [0x33],
        fn: function (arg) {
          decoded_data["acceleration_impact_grace_period"] = decode_field(
            arg,
            2,
            15,
            0,
      ...
      },
      {
        ...
        fn: function (arg) {
          ...
          var val = decode_field(arg, 1, 0, 0, "unsigned");
          {
            switch (val) {
              case 0:
                decoded_data["acceleration_mode"]["impact_threshold_enabled"] =
                  "Disable";
                break;
              case 1:
                decoded_data["acceleration_mode"]["impact_threshold_enabled"] =
      ...
      },
      {
        ...
        fn: function (arg) {
          ...
          var val = decode_field(arg, 1, 2, 0, "unsigned");
          {
            switch (val) {
              case 1:
                decoded_data["sensitivity"]["accelerometer_sample_rate"] =
                  "1 Hz";
                break;
              case 2:
                decoded_data["sensitivity"]["accelerometer_sample_rate"] =
          ...
          var val = decode_field(arg, 1, 5, 4, "unsigned");
          {
            switch (val) {
              case 0:
                decoded_data["sensitivity"]["accelerometer_measurement_range"] =
                  "±2 g";
                break;
              case 1:
                decoded_data["sensitivity"]["accelerometer_measurement_range"] =
      ...
      },
      {
        key: [0x36],
        fn: function (arg) {
          decoded_data["impact_alarm_grace_period"] = decode_field(
            arg,
            2,
            15,
            0,
      ...
      },
      {
        key: [0x37],
        fn: function (arg) {
          decoded_data["impact_alarm_threshold_count"] = decode_field(
            arg,
            2,
            15,
            0,
      ...
      },
      {
        key: [0x38],
        fn: function (arg) {
          decoded_data["impact_alarm_threshold_period"] = decode_field(
            arg,
            2,
            15,
            0,
      ...
      },
      {
        key: [0x39],
        fn: function (arg) {
          decoded_data["temperature_relative_humidity_sample_period_idle"] =
            decode_field(arg, 4, 31, 0, "unsigned");
          return 4;
        },
      },
      {
        key: [0x3a],
        fn: function (arg) {
          decoded_data["temperature_relative_humidity_sample_period_active"] =
            decode_field(arg, 4, 31, 0, "unsigned");
          return 4;
        },
      },
      {
        ...
        fn: function (arg) {
          ...
          decoded_data["temperature_threshold"]["high_temp_threshold"] =
            decode_field(arg, 2, 15, 8, "signed");
          decoded_data["temperature_threshold"]["low_temp_threshold"] =
            decode_field(arg, 2, 7, 0, "signed");
          return 2;
        },
      },
      {
        ...
        fn: function (arg) {
          var val = decode_field(arg, 1, 0, 0, "unsigned");
          {
            switch (val) {
              case 0:
                decoded_data["ambient_temperature_threshold_enabled"] =
                  "Disable";
                break;
              case 1:
                decoded_data["ambient_temperature_threshold_enabled"] =
      ...
      },
      {
        ...
        fn: function (arg) {
          ...
          decoded_data["rh_threshold"]["high_rh_threshold"] = decode_field(
            arg,
            2,
            15,
            8,
          ...
          decoded_data["rh_threshold"]["low_rh_threshold"] = decode_field(
            arg,
            2,
            7,
            0,
      ...
      },
      {
        key: [0x40],
        fn: function (arg) {
          decoded_data["mcu_temperature_sample_period_idle"] = decode_field(
            arg,
            4,
            31,
            0,
      ...
      },
      {
        key: [0x41],
        fn: function (arg) {
          decoded_data["mcu_temperature_sample_period_active"] = decode_field(
            arg,
            4,
            31,
            0,
      ...
      },
      {
        ...
        fn: function (arg) {
          ...
          decoded_data["mcu_temp_threshold"]["high_mcu_temp_threshold"] =
            decode_field(arg, 2, 15, 8, "signed");
          decoded_data["mcu_temp_threshold"]["low_mcu_temp_threshold"] =
            decode_field(arg, 2, 7, 0, "signed");
          return 2;
        },
      },
      ...
      },
      {
        key: [0x44],
        fn: function (arg) {
          decoded_data["analog_sample_period_idle"] = decode_field(
            arg,
            4,
            31,
            0,
      ...
      },
      {
        key: [0x45],
        fn: function (arg) {
          decoded_data["analog_sample_period_active"] = decode_field(
            arg,
            4,
            31,
            0,
      ...
      },
      {
        ...
        fn: function (arg) {
          ...
          decoded_data["analog_threshold"]["high_analog_threshold"] = (
            decode_field(arg, 4, 31, 16, "unsigned") * 0.001
          ).toFixed(3);
          decoded_data["analog_threshold"]["low_analog_threshold"] = (
            decode_field(arg, 4, 15, 0, "unsigned") * 0.001
          ).toFixed(3);
          return 4;
        },
      },
      ...
      },
      {
        key: [0x47],
        fn: function (arg) {
          decoded_data["light_sample_period"] = decode_field(
            arg,
            4,
            31,
            0,
      ...
      },
      {
        ...
        fn: function (arg) {
          ...
          decoded_data["light_thresholds"]["threshold_enabled"] = decode_field(
            arg,
            1,
            5,
            0,
      ...
      },
      {
        ...
        fn: function (arg) {
          ...
          var val = decode_field(arg, 1, 1, 1, "unsigned");
          {
            switch (val) {
              case 0:
                decoded_data["light_values_to_transmit"]["state_reported"] =
                  "Disabled";
                break;
              case 1:
                decoded_data["light_values_to_transmit"]["state_reported"] =
          ...
          var val = decode_field(arg, 1, 0, 0, "unsigned");
          {
            switch (val) {
              case 0:
                decoded_data["light_values_to_transmit"]["intensity_reported"] =
                  "Disabled";
                break;
              case 1:
                decoded_data["light_values_to_transmit"]["intensity_reported"] =
      ...
      },
      {
        key: [0x50],
        fn: function (arg) {
          decoded_data["pir_grace_period"] = decode_field(
            arg,
            2,
            15,
            0,
      ...
      },
      {
        key: [0x51],
        fn: function (arg) {
          decoded_data["pir_threshold"] = decode_field(
            arg,
            2,
            15,
            0,
      ...
      },
      {
        key: [0x52],
        fn: function (arg) {
          decoded_data["pir_threshold_period"] = decode_field(
            arg,
            2,
            15,
            0,
      ...
      },
      {
        ...
        fn: function (arg) {
          ...
          decoded_data["hold_off_int"]["post_turn_on"] = decode_field(
            arg,
            2,
            15,
            8,
          ...
          decoded_data["hold_off_int"]["post_disturbance"] = decode_field(
            arg,
            2,
            7,
            0,
      ...
      },
      {
        ...
        fn: function (arg) {
          var val = decode_field(arg, 1, 0, 0, "unsigned");
          {
            switch (val) {
              case 0:
                decoded_data["resp_to_dl_command_format"] =
      ...
      },
      {
        ...
        fn: function (arg) {
          ...
          decoded_data["metadata"]["app_major_version"] = decode_field(
            arg,
            7,
            55,
            48,
          ...
          decoded_data["metadata"]["app_minor_version"] = decode_field(
            arg,
            7,
            47,
            40,
          ...
          decoded_data["metadata"]["app_revision"] = decode_field(
            arg,
            7,
            39,
            32,
          ...
          decoded_data["metadata"]["loramac_major_version"] = decode_field(
            arg,
            7,
            31,
            24,
          ...
          decoded_data["metadata"]["loramac_minor_version"] = decode_field(
            arg,
            7,
            23,
            16,
          ...
          decoded_data["metadata"]["loramac_revision"] = decode_field(
            arg,
            7,
            15,
            8,
    ...
    decoder = [
      {
        key: [0x00, 0xba],
        fn: function (arg) {
          decoded_data["battery_voltage"] = (
            decode_field(arg, 2, 15, 0, "signed") * 0.001
          ).toFixed(3);
          return 2;
        },
      },
      ...
      },
      {
        key: [0x08, 0x04],
        fn: function (arg) {
          decoded_data["hall_effect_count"] = decode_field(
            arg,
            2,
            15,
            0,
      ...
      },
      {
        ...
        fn: function (arg) {
          ...
          decoded_data["acceleration"]["xaxis"] = (
            decode_field(arg, 6, 47, 32, "signed") * 0.001
          ).toFixed(3);
          decoded_data["acceleration"]["yaxis"] = (
            decode_field(arg, 6, 31, 16, "signed") * 0.001
          ).toFixed(3);
          decoded_data["acceleration"]["zaxis"] = (
            decode_field(arg, 6, 15, 0, "signed") * 0.001
          ).toFixed(3);
          return 6;
        },
      },
      ...
      },
      {
        key: [0x0f, 0x04],
        fn: function (arg) {
          decoded_data["extconnector_count"] = decode_field(
            arg,
            2,
            15,
            0,
      ...
      },
      {
        key: [0x12, 0x04],
        fn: function (arg) {
          decoded_data["extconnector_total_count"] = decode_field(
            arg,
            4,
            31,
            0,
      ...
      },
      {
        key: [0x11, 0x02],
        fn: function (arg) {
          decoded_data["extconnector_analog"] = (
            decode_field(arg, 2, 15, 0, "signed") * 0.001
          ).toFixed(3);
          return 2;
        },
      },
      {
        ...
        fn: function (arg) {
          decoded_data["mcu_temperature"] = (
            decode_field(arg, 2, 15, 0, "signed") * 0.1
          ).toFixed(1);
          return 2;
        },
      },
      {
        key: [0x03, 0x67],
        fn: function (arg) {
          decoded_data["ambient_temperature"] = (
            decode_field(arg, 2, 15, 0, "signed") * 0.1
          ).toFixed(1);
          return 2;
        },
      },
      {
        key: [0x04, 0x68],
        fn: function (arg) {
          decoded_data["relative_humidity"] = (
            decode_field(arg, 1, 7, 0, "unsigned") * 0.5
          ).toFixed(1);
          return 1;
        },
      },
      ...
      },
      {
        key: [0x10, 0x02],
        fn: function (arg) {
          decoded_data["light_intensity"] = decode_field(
            arg,
            1,
            7,
            0,
      ...
      },
      {
        key: [0x0d, 0x04],
        fn: function (arg) {
          decoded_data["motion_event_count"] = decode_field(
            arg,
            2,
            15,
            0,
    ...
    decoder = [
      {
        ...
        fn: function (arg) {
          ...
          var val = decode_field(arg, 5, 39, 32, "unsigned");
          {
            switch (val) {
              case 1:
                decoded_data["reset_diagnostics"]["reset_reason"] =
                  "Push-button reset";
                break;
              case 2:
                decoded_data["reset_diagnostics"]["reset_reason"] =
          ...
          decoded_data["reset_diagnostics"]["power_loss_reset_count"] =
            decode_field(arg, 5, 31, 24, "unsigned");
          decoded_data["reset_diagnostics"]["watchdog_reset_count"] =
            decode_field(arg, 5, 23, 16, "unsigned");
          decoded_data["reset_diagnostics"]["dl_reset_count"] = decode_field(
            arg,
            5,
            15,
            8,
          ...
          decoded_data["reset_diagnostics"]["button_reset_count"] =
            decode_field(arg, 5, 7, 0, "unsigned");
          return 5;
        },
      },
    ];
  ...
  // Convert decoded_data to TagoIO format
  var payload = [];
  var time = new Date().toISOString();

  for (var key in decoded_data) {
    if (
      typeof decoded_data[key] === "object" &&
      !Array.isArray(decoded_data[key])
    ) {
      for (var subKey in decoded_data[key]) {
        payload.push({
          variable: `${key}_${subKey}`,
          value: decoded_data[key][subKey],
          time: time,
        });
      }
    } else {
...
if (data) {
  const input = {
    bytes: Buffer.from(data.value, "hex"),
    fPort: port.value,
  };
