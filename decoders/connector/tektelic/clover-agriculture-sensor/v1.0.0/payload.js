  ...
  if (port === 10) {
    ...
    for (let i = 0; i < bytes.length; ) {
      ...
      if (channel === 0x00 && type === 0xba) {
        ...
        else if (byte <= 485) decoded.push({ variable: "soil_water_tension1", value: 200 - (byte - 293) * 0.5208, unit: "kPa" });
        else if (byte <= 600) decoded.push({ variable: "soil_water_tension1", value: 100 - (byte - 485) * 0.2174, unit: "kPa" });
        else if (byte <= 770) decoded.push({ variable: "soil_water_tension1", value: 75 - (byte - 600) * 0.1176, unit: "kPa" });
        else if (byte <= 1110) decoded.push({ variable: "soil_water_tension1", value: 55 - (byte - 770) * 0.05884, unit: "kPa" });
        else if (byte <= 2820) decoded.push({ variable: "soil_water_tension1", value: 35 - (byte - 1110) * 0.0117, unit: "kPa" });
        else if (byte <= 4330) decoded.push({ variable: "soil_water_tension1", value: 15 - (byte - 2820) * 0.003974, unit: "kPa" });
        else if (byte <= 6430) decoded.push({ variable: "soil_water_tension1", value: 9 - (byte - 4330) * 0.004286, unit: "kPa" });
        ...
        else if (byte <= 485) decoded.push({ variable: "soil_water_tension2", value: 200 - (byte - 293) * 0.5208, unit: "kPa" });
        else if (byte <= 600) decoded.push({ variable: "soil_water_tension2", value: 100 - (byte - 485) * 0.2174, unit: "kPa" });
        else if (byte <= 770) decoded.push({ variable: "soil_water_tension2", value: 75 - (byte - 600) * 0.1176, unit: "kPa" });
        else if (byte <= 1110) decoded.push({ variable: "soil_water_tension2", value: 55 - (byte - 770) * 0.05884, unit: "kPa" });
        else if (byte <= 2820) decoded.push({ variable: "soil_water_tension2", value: 35 - (byte - 1110) * 0.0117, unit: "kPa" });
        else if (byte <= 4330) decoded.push({ variable: "soil_water_tension2", value: 15 - (byte - 2820) * 0.003974, unit: "kPa" });
        else if (byte <= 6430) decoded.push({ variable: "soil_water_tension2", value: 9 - (byte - 4330) * 0.004286, unit: "kPa" });
    ...
    if (soil_moist_cont > 0 && soil_temp_cont > 0) {
      ...
      if (temp1.value && temp1.value !== 24.0 && moist1.value) {
        decoded.push({ variable: "soil_water_tension1_adjusted", value: moist1.value * (1 - 0.019 * (temp1.value - 24)), unit: "kPa" });
      }
      if (temp2.value && temp2.value !== 24.0 && moist2.value) {
        decoded.push({ variable: "soil_water_tension2_adjusted", value: moist2.value * (1 - 0.019 * (temp2.value - 24)), unit: "kPa" });
      }
    }
  }
