...
** [{ "variable": "payload", "value": "018500020C079022" }]
**
** The ignore_vars variable in this code should be used to ignore variables
** from the device that you don't want.
*/

// let payload = [{ variable: 'payload', value: '018500020C079022' }];
...
function parsePayload(payload_raw) {
  try {
    ...
    if (sensor_reading_type === 0) {
      const level = ((K * bytes.readUIntBE(3, 2) * m) + b) / liquid_density;
      // ((K*Pressure sensor output (DEC)*m)+b)/liquid density
