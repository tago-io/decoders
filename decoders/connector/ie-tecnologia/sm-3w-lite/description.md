...
O SM-3W Lite transmite um objeto JSON com 40 campos usando nomes curtos (ex: `pa`, `uarms`, `freq`). Todos os valores são enviados como strings. O decoder converte esses campos em variáveis individuais no formato TagoIO com nomes descritivos e unidades corretas.