...
const file_path =
  "decoders/connector/ie-tecnologia/sm-3w/v1.0.0/payload.ts";
...
describe("SM-3W — Payload completo via variável 'payload'", () => {
...
describe("SM-3W — Payload via variável 'data'", () => {
  let result: DataToSend[];
...
describe("SM-3W — Valores realistas", () => {
  let result: DataToSend[];
...
describe("SM-3W — JSON puro via HTTP POST direto", () => {
  let result: DataToSend[];
