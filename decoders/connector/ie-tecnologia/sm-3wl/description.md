...
The SM-3WL transmits a JSON object with 66 fields using short tag names (e.g., `pa`, `uarms`, `freq`, `delta_epa_c`). All values are sent as strings. The decoder converts these into individual TagoIO variables with descriptive names and proper units.