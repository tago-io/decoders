...
const file_path =
  "decoders/connector/ie-tecnologia/sm-3wl/v1.0.0/payload.ts";
...
describe("SM-3WL — Payload completo via variável 'payload'", () => {
...
describe("SM-3WL — Payload via variável 'data'", () => {
  let result: DataToSend[];
...
describe("SM-3WL — JSON puro via HTTP POST direto", () => {
  let result: DataToSend[];
...
describe("SM-3WL — x-www-form-urlencoded (JSON como chave do objeto)", () => {
  let result: DataToSend[];
