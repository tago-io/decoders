/**
 * IE Tecnologia SM-3WL — Decoder para medidor de energia trifásico com WiFi
 *
 * Converte o payload JSON enviado pelo SM-3WL em variáveis TagoIO.
...
function findPayload(payload: any[]): Record<string, string> | null {
  ...
  for (const item of payload) {
    ...
    if (item && typeof item === "object" && !item.variable && item.uarms !== undefined && item.tec !== undefined) {
      return item;
    }
