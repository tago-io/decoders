...
Copyright (c) 2024 TagoIO Inc. and contributors.
...
Logos, icons, and brand images under `decoders/` belong to their respective owners (device
manufacturers, network providers, and other third parties) and are included for identification
on the TagoIO platform. These assets are not covered by the Apache License 2.0.
